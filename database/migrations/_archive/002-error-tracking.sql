-- Migration: Add Error Tracking System
-- Date: 2026-02-07
...
CREATE INDEX idx_error_logs_unresolved ON error_logs(resolved, timestamp DESC)
...
-- For analytics
CREATE INDEX idx_error_logs_org ON error_logs(org_id, timestamp DESC)
  WHERE org_id IS NOT NULL;
CREATE INDEX idx_error_logs_request ON error_logs(request_id)
  WHERE request_id IS NOT NULL;

-- For deduplication
CREATE INDEX idx_error_logs_fingerprint ON error_logs(error_type, error_message, org_id);
