...
describe('Tier Boundary Tests', () => {
  ...
  describe('MEDIUM tier boundaries', () => {
    it('should be MEDIUM with score in MEDIUM range', () => {
      // Inputs that produce score in 60-85 range while meeting MEDIUM gates
      // (coverage ≥ 90%, exceptions ≤ 5, drift ≤ MEDIUM)
      const fcs = generateFCSFromAnalysis(createMockInputs({
        reconciliation: {
          all_reconciled: false,
          discrepancies: [{ p: 1 }, { p: 2 }, { p: 3 }],
