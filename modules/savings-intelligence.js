...
const { PricingService, FALLBACK_MODEL_PRICING, FALLBACK_INDUSTRY_BENCHMARKS } = require('../platform/pricing-service');

// ============================================================================
// PRICING DATA - FALLBACK CONSTANTS (Updated January 2026)
// ============================================================================

const FALLBACK_MODEL_PRICING_DATA = FALLBACK_MODEL_PRICING;
...
class SavingsIntelligence {
  constructor(config = {}) {
    ...
    this.pricingService = config.pricingService || null;
