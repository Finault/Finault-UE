 ...
 * Bundles the 15,010-line gateway-wired.js + 14 Diamond modules + platform into
 * a single Cloudflare Worker bundle at dist/gateway.js
 */
...
async function buildGateway() {
  ...
  try {
    const result = await build({
      entryPoints: [path.join(ROOT, 'apps/gateway/gateway-wired.js')],
      bundle: true,
